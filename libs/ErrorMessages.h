...
#define ERR_MSG_SOCKET_LISTEN "No se pudo establecer la cantidad de conexiones"\
                                "en espera: %s."
#define ERR_MSG_SOCKET_INVALID_HOST_OR_PORT "Host %s o puerto %s inválido: %s."
#define ERR_MSG_CONNECTION_COULD_NOT_BE_STABLISHED "La conexión a %s:%s no "\
...
#define ERR_MSG_SOCKET_CLOSED_UNEXPECTLY "Error: terminación inesperada al "\
                                            "recibir un mensaje."
