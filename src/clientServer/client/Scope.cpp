...
void Weapon::Scope::render(GUI::Position &p, GUI::Camera &cam,
                           SDL_RendererFlip &flip){
    GUI::Position scopePos =
            GUI::Position(SCOPE_DISTANCE * cos(this->angle * PI / 180),
                          SCOPE_DISTANCE * sin(this->angle * PI / 180)) + p;
