...
#define CLUSTER_FRAGMENT_MIN_ANGLE -84.375f
#define CLUSTER_FRAGMENT_MAX_ANGLE 90
#define CLUSTER_FRAGMENT_RESTITUTION 0.1f
#define CLUSTER_FRAGMENT_FRICTION 0.1f
#define CLUSTER_FRAGMENT_TIMEOUT 0
#define CLUSTER_FRAGMENT_ANGLE_STEP 5.625f
#define CLUSTER_FRAGMENT_SHOT_POWER 50
#define CLUSTER_FRAGMENT_QUANTITY 1
// Mortar
