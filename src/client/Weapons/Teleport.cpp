...
Worm::Teleport::Teleport(const GUI::GameTextureManager &tex)
    : Weapon(tex, GUI::GameTextures::WormTeleport, TELEPORT_CENTER_FRAME, WeaponID::WTeleport) {
...
void Worm::Teleport::render(GUI::Position &p, GUI::Camera &cam, SDL_RendererFlip &flip) {
